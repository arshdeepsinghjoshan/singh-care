...
<form id="blog-category-form" class="row needs-validation justify-content-center" action="{{ route(empty($model->exists) ? 'wallet.add' : 'wallet.update',$model->id) }}" method="post" novalidate>
    @csrf
